        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div data-aos="fade-right">
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-purple-400 to-amber-400 rounded-full blur-xl opacity-60"></div>
              <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-gradient-to-br from-amber-400 to-blue-400 rounded-full blur-xl opacity-40"></div>
            </div>
          </div>
          ...
          <div data-aos="fade-left">
            <div className="glass-card rounded-3xl p-8 hover-glow">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-amber-600 mb-2">Student</div>
                  <div className="text-gray-600">Data Science</div>
                </div>
              </div>
            </div>
          </div>
