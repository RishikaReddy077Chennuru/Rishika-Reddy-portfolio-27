  ...
  return (
    <section id="top" className="relative overflow-hidden pt-36 pb-28 sm:pt-44 sm:pb-40">
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          I'm <span className="text-ink bold font-extralarge">Rishika Reddy Chennuru</span>{" "}
           — a Builder &amp; Designer shaping thoughtful products with machine learning, generative AI, and interfaces people actually enjoy using.
        </motion.p>
        ...
        >
          ...
          <div className="absolute -left-6 -top-6 hidden h-28 w-28 rounded-full bg-[var(--lavender-soft)] shadow-luxe sm:block animate-float-slower" />
          <div className="absolute -bottom-8 -right-14 hidden h-28 w-28 rounded-full bg-[var(--lavender-soft)] shadow-luxe sm:block animate-float-slower" />
        </motion.div>
      </div>
    </section>
  );
