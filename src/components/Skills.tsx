...
const Skills = () => {
  ...
  return (
    <section id="skills" className="relative py-16 sm:py-20 lg:py-24 responsive-container">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {skillCategories.map((category, index) => (
            <div 
              key={category.title}
              className="glass-card rounded-3xl p-6 sm:p-8 hover:glass-strong transition-all duration-300 hover-glow"
              data-aos="fade-up"
