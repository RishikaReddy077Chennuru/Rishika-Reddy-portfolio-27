  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-orange-200/25 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-200/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto flex-1 flex flex-col justify-center">
        <div className="hero-text mb-4">
          <h2 className="text-xl md:text-2xl text-evening-accent font-light mb-4">
            Hello, I'm
          </h2>
        </div>
        ...
        <div className="hero-text mb-6">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 leading-tight glow-text">
            <span className="bg-gradient-to-r from-purple-600 via-orange-400 to-blue-500 bg-clip-text text-transparent">
        ...
        <div className="hero-cta mb-12">
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="glass-strong bg-gradient-to-r from-purple-500 to-orange-400 hover:from-purple-600 hover:to-orange-500 text-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-2xl">
              View My Work
            </button>
        ...
        <div className="flex justify-center space-x-6">
          ...
          <a href="mailto:rishikareddychennuri@gmail.com" className="social-link text-evening-secondary hover:text-orange-500 transition-colors duration-300 transform hover:scale-110">
            <Mail size={28} />
          </a>
        </div>
      </div>
